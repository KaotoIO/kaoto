describe('Tests for Design page', () => {
  ...
  it('Design - duplicate steps in CamelRoute', () => {
    ...
    cy.checkCodeSpanLine('- marshal:', 2);
    cy.checkCodeSpanLine('id: when', 2);
  });
  ...
  it('Design - duplicate nodes in RouteConfiguration', () => {
    ...
    cy.openSourceCode();
    cy.editorScrollToTop();
    cy.checkCodeSpanLine('- intercept:', 2);
    cy.checkCodeSpanLine('- interceptFrom:', 2);
    cy.checkCodeSpanLine('- interceptSendToEndpoint:', 2);
  });
  ...
  it('Design - duplicate RouteConiguration', () => {
    ...
    cy.openSourceCode();
    cy.editorScrollToTop();
    cy.checkCodeSpanLine('- routeConfiguration:', 2);
  });
  ...
  it('Design - duplicate steps in Pipe', () => {
    ...
    cy.openSourceCode();
    cy.checkCodeSpanLine('json-deserialize-action', 2);
