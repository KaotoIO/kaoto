...
import { TreeParsingService } from '../visualization/tree-parsing.service';
import { VisualizationUtilService } from '../visualization/visualization-util.service';
...
describe('DocumentUtilService', () => {
  ...
  describe('type override with supplementary schema (extension type)', () => {
    ...
    it('should show overridden field children in tree rebuild (full TreeParsingService flow)', () => {
      ...
      // Rebuild tree (simulates what happens after document reference change)
      ...
      const newAddressField = VisualizationUtilService.getField(newAddressTreeNode!.nodeData);
