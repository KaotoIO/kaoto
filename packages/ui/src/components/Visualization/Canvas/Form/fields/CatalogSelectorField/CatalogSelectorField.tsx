...
import { selectDefaultCatalogForRuntime } from '../../../../../../utils/catalog-helper';
...
export const CatalogSelectorField: FunctionComponent<FieldProps> = ({ propName, required }) => {
  ...
  const isTest = propName === 'testingCatalog' || propName === 'citrusCatalog' || lowerPropName.includes('testing');
  ...
  const displayName = useMemo(() => {
    ...
    if (value.version === '') {
      const defaultCatalog = selectDefaultCatalogForRuntime(catalogOptions, value.runtime);
