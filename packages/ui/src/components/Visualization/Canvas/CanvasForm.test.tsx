...
describe('CanvasForm', () => {
  ...
  it('should persists changes from both expression editor and main form', async () => {
    const camelRoute = {
      from: {
        uri: 'timer:tutorial',
        steps: [
  ...
  it('should persists changes from both dataformat editor and main form', async () => {
    const camelRoute = {
      from: {
        uri: 'timer:tutorial',
        steps: [
  ...
  it('should persists changes from both loadbalancer editor and main form', async () => {
    const camelRoute = {
      from: {
        uri: 'timer:tutorial',
        steps: [
