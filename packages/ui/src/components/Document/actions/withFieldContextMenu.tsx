  ...
  const WithContextMenu = (props: P) => {
    ...
    const menuGroups = useMemo(() => {
      ...
      return [
        ...
        { actions: [{ label: 'Override Field...', onClick: handleOverrideType }] },
        hasFieldOverride ? { actions: [{ label: 'Reset Override', onClick: handleResetOverride }] } : { actions: [] },
      ];
    }, [
      isChoiceWrapper,
      isSelectedChoice,
