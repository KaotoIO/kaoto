...
export interface ITreeItemFieldAndNodeRefsAndDnDProps {
  ...
  position?: number;
  setSize?: number;
  renderActions?: (field: IField) => IDocumentFieldProps['actions'];
  renderPreview?: (field: IField) => ReactNode;
                    ...
                    <DocumentField
                      ...
                      statusIcons={[
                        field.isConnected ? (
                          ...
                          >
                            <CircleIcon label={'This field is connected'} size="sm" tabIndex={-1} />
                          </Tooltip>
                        ) : null,
                        field.isCollection ? (
                          <Tooltip
                          ...
                          >
                            <LayerGroupIcon label={'This field is a collection'} size="sm" tabIndex={-1} />
                          </Tooltip>
                        ) : null,
                        field.hasTransformations ? (
                          ...
                          >
                            <BoltIcon label={'This field has transformations'} size="sm" tabIndex={-1} />
                          </Tooltip>
                        ) : null,
                        field.isAttribute ? (
                          <Tooltip
                          ...
                          >
                            <AtIcon label={'This field is an attribute'} size="sm" tabIndex={-1} />
                          </Tooltip>
                        ) : null,
                      ]}
