...
export const useDocumentTreeStore = createWithEqualityFn<DocumentTreeState>()(
  devtools(
    (set, get) => ({
      ...
      /** @deprecated Only increments version without updating positions - use useConnectionPortSync instead */
      refreshConnectionPorts: () => {
        // This method is deprecated and does nothing useful
        // Connection ports are now updated automatically via useConnectionPortSync effects
      },
