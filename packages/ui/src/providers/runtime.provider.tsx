...
> = (props) => {
  ...
  useEffect(() => {
    ...
    const catalogLibraryEntry = findCatalog(
      currentSchemaType,
      catalogLibrary,
      props.camelCatalog,
      props.testingCatalog,
    );

    setSelectedCatalog(catalogLibraryEntry);
  }, [catalogLibrary, currentSchemaType, props.camelCatalog, props.testingCatalog, compatibleRuntimes]);
  ...
  const runtimeContext: IRuntimeContext = useMemo(
    () => ({
      ...
      setSelectedCatalog,
      compatibleRuntimes,
      camelCatalog: props.camelCatalog,
      testingCatalog: props.testingCatalog,
    }),
    [basePath, catalogLibrary, selectedCatalog, compatibleRuntimes, props.camelCatalog, props.testingCatalog],
  );
