...
export abstract class AbstractCamelVisualEntity<T extends object> implements BaseVisualCamelEntity {
  ...
  toVizNode(): VizNodeWithEdges {
    ...
    const fromNodeWithEdges = NodeMapperService.getVizNode(
    ...
    routeGroupNode.addChild(fromNodeWithEdges.vizNode);
    return { vizNode: routeGroupNode, edges: fromNodeWithEdges.edges };
  }
