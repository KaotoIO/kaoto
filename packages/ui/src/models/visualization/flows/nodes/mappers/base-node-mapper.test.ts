...
describe('BaseNodeMapper', () => {
  ...
  describe('getVizNodeFromProcessor', () => {
    it('should return a VisualizationNode', () => {
      const vizNode = mapper.getVizNodeFromProcessor(path, componentLookup, entityDefinition)[0];
    ...
    it('should return a VisualizationNode with children', () => {
      ...
      const vizNode = mapper.getVizNodeFromProcessor(path, componentLookup, routeDefinition)[0];
