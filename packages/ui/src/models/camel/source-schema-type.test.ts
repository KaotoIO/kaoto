...
describe('getResourceTypeFromPath', () => {
  const cases: [string, SourceSchemaType | undefined][] = [
    ...
    ['my.test.yaml', SourceSchemaType.Test],
    ['my-test.yaml', SourceSchemaType.Test],
    ['my-test.yml', SourceSchemaType.Test],
    ['my.test.xml', SourceSchemaType.Test],
    ['my-test.xml', SourceSchemaType.Test],
    ['my.it.yaml', SourceSchemaType.Test],
    ['my-it.yaml', SourceSchemaType.Test],
    ['my-it.yml', SourceSchemaType.Test],
    ['my.it.xml', SourceSchemaType.Test],
    ['my-it.xml', SourceSchemaType.Test],
    ['yaml', undefined],
    ['yml', undefined],
    ['my.json', undefined],
