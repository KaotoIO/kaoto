...
*/
import { NodeRect, useNodeRect } from '../../../providers/NodeRefProvider';
import React, { HTMLAttributes, forwardRef, useCallback, useEffect, useState } from 'react';

import { useCanvas } from './CanvasContext';

const printNodeRef = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(function PrintNodeRef(
  { id, children, ...props },
  ref,
) {
