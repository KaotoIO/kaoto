...
import { constants, mappings, properties, sources, targets } from '../atlasmap/stories/sampleData';

import { action } from '@storybook/addon-actions';
import { boolean } from '@storybook/addon-knobs';
import decorators from '../atlasmap/stories/decorators';
...
export const sourceTargetView = () =>
  createElement(() => {
    ...
    const shouldShowMappingPreviewForField = (f: IField) =>
          ...
          <SourceTargetView
            sourceEvents={{
              ...
              canAddFieldToSelectedMapping: (item) =>
                !!selectedMappingId && !item.mappings.find((m) => m.id === selectedMappingId),
