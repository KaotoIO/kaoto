...
* **309:** Add codeblock to unknown node ([cdd7541](https://github.com/KaotoIO/kaoto-next/commit/cdd7541a81a9cb72290c90361fbcab9494335f40))
* **593:** metadata editor change visual metadata in canvas ([16e77f9](https://github.com/KaotoIO/kaoto-next/commit/16e77f97abd02d7731a15f0537ee9614947433dc))
* **619:** Update onClose event handler in ExpressionModalLauncher ([3d49bce](https://github.com/KaotoIO/kaoto-next/commit/3d49bce728ed8927660414530cd0e84df3024c82))
* **626:** add dropbox handler for clicking outside the dropdown ([e405820](https://github.com/KaotoIO/kaoto-next/commit/e405820ba38218dd30fae45e59e09a8db13f93e6))
* **638:** make canvas modal top alligned ([fb224f4](https://github.com/KaotoIO/kaoto-next/commit/fb224f496884f5c1e6148b40c507f83d73c2d31e))
* Camel 4.3.0 adjustment ([2b09972](https://github.com/KaotoIO/kaoto-next/commit/2b09972fa26463061a300aa712161abac33c1f56))
...
* **form:** Improve vertical spacing for form ([7357de1](https://github.com/KaotoIO/kaoto-next/commit/7357de16c203598e90f9b7b6086879e3c04f1e89))
* **kamelets:** Edit Kamelets' nodes properties ([1d2998c](https://github.com/KaotoIO/kaoto-next/commit/1d2998ce592cc090e55bbfb01ff723a17666f116))
* Missing expression editor for setHeaders EIP ([91cc8bd](https://github.com/KaotoIO/kaoto-next/commit/91cc8bddf821384cd4a2adb2907868eac84877d0)), closes [#577](https://github.com/KaotoIO/kaoto-next/issues/577) [#523](https://github.com/KaotoIO/kaoto-next/issues/523) [#568](https://github.com/KaotoIO/kaoto-next/issues/568)
* **pipe:** Set Pipe's properties in the right place ([79aec4c](https://github.com/KaotoIO/kaoto-next/commit/79aec4c5f652f4b125d1a06f1faf83ed500c601a))
* **schemas:** Avoid mutating component schemas ([2da23b8](https://github.com/KaotoIO/kaoto-next/commit/2da23b8b7f0f3747606759de5cd998b81060bebb))
* **stylelint:** Update stylelint to incorporate lightness-notation rule used by stylelint-config-standard-scss ([15fd7f6](https://github.com/KaotoIO/kaoto-next/commit/15fd7f679ab9bffee577ede4e1ba354d0ca46236))
* **windows:** Copying Catalog on Windows is not working ([7b2ffce](https://github.com/KaotoIO/kaoto-next/commit/7b2ffceafdb2cca29eff9b618c138f3965446ae7))
* **windows:** Fix running unit tests in Windows ([c0fc064](https://github.com/KaotoIO/kaoto-next/commit/c0fc0641dd1f364e8053453be97034435a1d86e8))
...
* **form:** Parse URI field into parameters ([87b659d](https://github.com/KaotoIO/kaoto-next/commit/87b659dafe6a2ad0b8f86499a36d7eda14f6831d))
* **form:** Parse URI field upon configuring step ([091655c](https://github.com/KaotoIO/kaoto-next/commit/091655c5f92744596d96173885d34fefeab53539))
* **sourcecode:** Sort Camel Routes parameters ([ceb0083](https://github.com/KaotoIO/kaoto-next/commit/ceb0083b48972f1111434e217b96d73fb471195d))
