...
public class CamelCatalogProcessorTest {
    ...
    public CamelCatalogProcessorTest() throws IOException {
    ...
    public void testProcessCatalog() throws Exception {
        var catalogMap = processor.processCatalog(yamlDslSchema);
        ...
        assertEquals(processor.getPatternCatalog(yamlDslSchema), catalogMap.get("patterns"));
    }
    ...
    public void testGetDataFormatCatalog() throws Exception {
        ...
        var customModel = dataFormatCatalog
                .withObject("/custom")
                .withObject("/dataformat");
        assertEquals("dataformat", customModel.get("kind").asText());
    ...
    public void testGetLanguageCatalog() throws Exception {
        ...
        var customModel = languageCatalog
                .withObject("/language")
                .withObject("/language");
        assertEquals("language", customModel.get("kind").asText());
    ...
    public void testGetPatternCatalog() throws Exception {
        var processorCatalog = jsonMapper.readTree(new CamelCatalogProcessor().getPatternCatalog(yamlDslSchema));
