...
import { MappingNodeData, TargetDocumentNodeData, TargetFieldNodeData } from '../../../models/visualization';
import { TestUtil } from '../../../test/test-util';
import { ChooseItem, FieldItem, MappingTree } from '../../../models/mapping';
